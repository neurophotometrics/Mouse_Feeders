...
void UpdateDisplay() {
  ...
  if (FEDmode == 6 && compulsive == true) {
    display.setCursor(5, 36);
    display.print("Compulsive Active");
  }

  if (FEDmode == 6 && compulsive == false) {
    display.setCursor(5, 36);
    display.print("Compulsive Idle");
  }
  ...
  if (FEDmode == 8) {
    display.setCursor(5, 36);
    display.print("Prob Revers ");
    display.print(rewardProb);
    display.print("/");
    display.print(100 - rewardProb);
  }
...
//    display.print(rewardedTrial);
  ...
  ********************************************************/
  ...
  if (FEDmode > 0) {
    ...
    if (activePoke == 0 && rewardedTrial == true && Ratio_Met == false && rewardedTrial == true) {
      display.fillTriangle (12, 55, 18, 59, 12, 63, WHITE);
      display.fillTriangle (12, 75, 18, 79, 12, 83, BLACK);
    }

    if (activePoke == 1 && rewardedTrial == true && Ratio_Met == false && rewardedTrial == true) {
...
void StartUpDisplay () {
  ...
  for (int i = -50; i < 200; i += 15) {
    ...
    delay (80);
    display.refresh();
    display.fillRoundRect (i - 25, 65, 90, 35, 1, WHITE);
